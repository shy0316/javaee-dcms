...
<div class="top">
		...
		<div class="aside">
			...
			<span class="manager"><a href="/competion/index.jsp">管理员</a></span>
			<div>
				<input type="text" class="text"><input type="button"
					value="搜索" class="search">
			</div>
		</div>
		<div class="noticenav" style="width: 1200px;
	height: 100px;
	background: #09386b;
...
<span style="position:absolute;
	...
	line-height:40px;
	font-size:16px;
	font-family: "Microsoft YaHei""><a href="searchnotice.action">&nbsp;返回&nbsp;</a></span>
<div style="position:relative;top:180px;left:45%;color:#09386b;font-size:24px;font-family:'Microsoft Yahei'">
${message}
</div>
<div class="foot" style="position:relative;top:300px;">
