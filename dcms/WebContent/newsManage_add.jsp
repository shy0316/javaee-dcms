		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="newsManage_add.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="newsManage_add.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="newsManage_add.jsp"><i class="icon fa fa-list-alt"></i>新闻录入</a></li>
							</ol>						
						</div>
							...
							<div class="pannel pannel-heading bk-bg-very-light-gray">
								<div class="row">
									<div class="col-md-8 col-md-offset-2 text-center bk-vcenter ">
										<h3 class="border-bottom-primary text-primary  bk-padding-top-10 bk-padding-bottom-15">新闻信息录入</h3>
									</div>
								</div>
							</div>
							<div class="panel-body bk-bg-very-light-gray">
								<form class="form-horizontal" role="form" action="addNews.action" method="post" enctype="multipart/form-data">
							        <div class="form-group">
							          <label class="col-md-3 control-lable text-right" for="text-input">新闻标题：</label>
							          <div class="col-md-5 bk-padding-0">
							          	 <input type="text" id="manage-name-inp" name="news.newsTitle" class="form-control" placeholder="请输入新闻标题" required>
							          </div>
							        </div>
							        <div class="row">
                                        <label class="col-md-3 text-right" for="text-input">新闻发布者：</label>
							            <div class="col-md-2">
							                <input type="text" id="manage-issuer-inp" name="news.newsIssuer" class="form-control" placeholder="请输入新闻发布者"  required>
							            </div>
							            <label class="col-md-1 text-right" for="text-input">发布时间：</label>
							            <div class="col-md-2 bk-padding-0">
                                            <div class="input-group">
                                                <input type="text" id="time" data-plugin-datepicker name="news.newsIssuedate" class="form-control" required>
                                            </div>
                                        </div>
							        </div>
							        <div class="form-group">
							        	...
							        	<div class="row">
							        		<div class="col-md-offset-3 col-lg-7 col-md-7 bk-padding-0">
							          		 	<textarea  id="manage-content-inp" name="news.newsContent" class="form-control" rows="13" required></textarea>
							         		</div>
							        	</div>
							        </div>
							        <div class="form-group">
							          <label class="col-md-3 col-md-3 col-sm-12 control-lable text-right" for="text-input">新闻展示图：</label>
							          <div class="col-lg-5 col-md-6 bk-padding-0">
							          	 <input type="file" name="newsPhoto"  class="form-control">
							          </div>
							        </div>
							        <div class="row"><button id="sub-btn" type="submit" class="btn btn-success col-md-1 col-md-offset-5">提交</button></div>
							      </form>
							</div>		
						</div>
					</div>	
