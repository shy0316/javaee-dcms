		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="check.action?competition.comId=<s:property value="comId"/>#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="check.action?competition.comId=<s:property value="comId"/>#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="check.action?competition.comId=<s:property value="comId"/>"><i class="icon fa fa-list-alt"></i>竞赛详情</a></li>
							</ol>						
						</div>
			...
			<s:iterator value="list" id="x" >
				<div class="row panel  bk-bg-very-light-gray bk-border-off">
					<div class="col-md-10 col-md-offset-1">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center bk-vcenter bk-fg-inverse bk-padding-20">
								<h1 class="bk-margin-off"><s:property value="#x.comName" /></h1>
							</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-md-10 col-md-offset-1 bk-padding-10">
								<div class="col-md-4 text-center">浏览次数:</div>
								<div class="col-md-8">${applicationScope.counter}</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-5 col-md-offset-1 bk-padding-10">
								<div class="col-md-5 text-right">发布者:</div>
								<div class="col-md-5"><s:property value="#x.issuer"/></div>
							</div>
							<div class="col-md-5 bk-padding-10">
								<div class="col-md-5 text-right">发布时间:</div>
								<div class="col-md-5"><s:property value="#x.publishTime"/></div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-10 col-md-offset-1 bk-padding-10">
								<div class="col-md-4 text-center">举办单位:</div>
								<div class="col-md-8"><s:property value="#x.holdingUnit"/></div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-5 col-md-offset-1 bk-padding-10">
								<div class="col-md-5 text-right">竞赛级别:</div>
								<div class="col-md-5"><s:property value="#x.scale"/></div>
							</div>
							<div class="col-md-5 bk-padding-10">
								<div class="col-md-5 text-right">竞赛类型:</div>
								<div class="col-md-5"><s:property value="#x.type"/></div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-5 col-md-offset-1 bk-padding-10">
								<div class="col-md-5 text-right">开始报名时间:</div>
								<div class="col-md-5"><s:date name="#x.enterStart" format="yyy/MM/dd" /></div>
							</div>
							<div class="col-md-5 bk-padding-10">
								<div class="col-md-5 text-right">截止报名时间:</div>
								<div class="col-md-5"><s:date name="#x.enterStop" format="yyy/MM/dd" /></div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-10 col-md-offset-1 bk-padding-20 text-justify">
								<pre class="">
									<s:property value="#x.comContent"/>
								</pre>
							</div>
						</div>
						<div class="row">
							<div class="col-md-10 col-md-offset-1 bk-padding-20 text-justify">
								<div class="col-md-1 text-right">附件:</div>
								<div>
									<a type="application/msword" href="http://localhost:8080/dcms/file/<s:property value="#x.comLink"/>">
										<s:property value="#x.comLink" />
									</a>
								</div>
							</div>
						</div>
