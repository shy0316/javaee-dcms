		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="newsManage.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="newsManage.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="showNews.action"><i class="icon fa fa-list-alt"></i>新闻管理</a></li>
							</ol>						
						</div>
							...
							<div class="pannel pannel-heading ">
								<div class="row">
									<div class="col-xs-12 text-center bk-vcenter">
										<h3 class="border-bottom-primary text-primary  bk-padding-top-10 bk-padding-bottom-15">新闻信息管理</h3>
									</div>
								</div>
							</div>
							<div class="panel-body bk-padding-20">
								<form action="searchNews_manage.action" class="form-horizontal" role="form"  method="post" enctype="multipart/form-data">
									<div class="row ">
										<div class="col-md-11">
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon">新闻标题</span>
													<input type="text" name="news.newsTitle" class="form-control " placeholder="title" value="">
									...
									<div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon">新闻发布者</span>
                                                    <input type="text" name="news.newsIssuer" class="form-control" placeholder="newsIssuer" value="">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon">新闻发布时间</span><!-- data-plugin-datepicker -->
                                                    <input type="date"  name="news.newsIssuedate" class="form-control" value="">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <button name="query" type="submit" class="btn">查询</button>
                                        </div>
									</div>
								</form>
							</div>		
									...
									<div class="table-responsive bk-vcenter">	
										<table class="table table-striped  bootstrap-datatable datatable">
											...
											<tbody>		
												...
												<tr>
													<td class="titletd"> <s:property value="newsTitle"/> </td>
													<td><s:property value="#x.newsIssuer" /></td>
													<td><s:property value="#x.newsIssuedate" /></td>
													<td><a href="newsContent_manage.action?news.newsTitle=<s:property value="newsTitle"/>" class="btn-check"><i class="fa fa-search-plus "></i>&nbsp;&nbsp;&nbsp;详情</a></td>
													<td><a href="newsModify_manage.action?news.newsTitle=<s:property value="newsTitle"/>" class="btn-modify"><i class="fa fa-edit "></i>&nbsp;&nbsp;&nbsp;修改</a></td>
													<td><a onclick="if(confirm('您确定要删除此新闻吗？')==false) return false;" href="delNews.action?news.newsTitle=<s:property value="newsTitle"/>"  class="btn-delete"><i class="fa fa-trash-o "></i>&nbsp;&nbsp;&nbsp;删除</a></td> 
												</tr>
												</s:iterator>
											</tbody>
										</table>
