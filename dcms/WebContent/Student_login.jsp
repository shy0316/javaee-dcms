							...
							<div class="panel-body">
								<form action="login_student.action" method="post">
									<div class="form-group">
										<label>账 号</label><label style="color:red;font-family:'Microsoft Yahei'">${requestScope.message}${requestScope.loginMessage}</label>
									...
									<div class="row">
										...
										<div class="col-sm-4 text-right">
											<button type="submit" class="btn btn-primary hidden-xs" onclick="return loginNullCheck()">登 录</button>
									...
									<p class="text-center">还未注册? <a href="Student_regist.jsp">注册!</a>
								</form>
							</div>
						</div>
					</div>
