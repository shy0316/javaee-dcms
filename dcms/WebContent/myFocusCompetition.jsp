               ...
               <div class="container">
                 ...
                 <ul class="category-list slide">
                     ...
                     <div class="posts-block col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        ...
                        <h3 class="title">我关注的竞赛</h3>
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                           <table class="table table-striped  bootstrap-datatable datatable " id="mytable">
                                        <thead>
                                            <tr>
                                                <th >竞赛名称</th>
                                        ...
                                        <tbody id="mycompetition">
                                            <!-- 
                                            <tr>
                                                <td class="titletd">校学子在全国英语写作大赛江苏赛区比赛中取得佳绩</td>
                                            </tr>
                        ...
                        <div class="pagination-centered bottom2">
                           <ul class="pagination">
	...
	$(function(){
		...
		$.ajax({
			...
			success : function(data) {
				var competitionlist = data.competitionlist;
				var perferencelist = data.perferenceslist;
