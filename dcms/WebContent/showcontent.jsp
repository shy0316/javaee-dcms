         ...
         <div id="main">
                     ...
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <div class="breadcrumbs pull-right">
                           <ul>
                              ...
                              <li><a href="listc.action">成果展示</a></li>
                              <li>成果详情</li>
                           </ul>
                        </div>
                     </div>
            ...
            <div class="content">
               <div class="container">
                  ...
                  <!-- content-top start -->
                   ...
                   <div class="posts-block col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                     <div class="posts-block col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                        ...
                        <img alt="获奖图片" src="<s:property value="#x.awardPicpath"/>" class="img-thumbnail contentimg" >
                     </div>
                     <div class="posts-block col-lg-8 col-md-8 col-sm-8 col-xs-12 rescontent contentfirst">
                       <ul>
                       
             			<li><b>队伍名称:</b>&nbsp;<s:property value="#x.teamName"/>
             			<li><b>队伍学院:</b>&nbsp;<s:property value="#x.college"/>
              			<li><b>指导老师:</b>&nbsp;<s:property value="#x.teacher"/>
             			<li><b>队伍成员:</b>&nbsp;<s:property value="#x.stuId1"/>,<s:property value="#x.stuId2"/>,<s:property value="#x.workName"/>
             			<li><b>作品名称:</b>&nbsp;<s:property value="#x.production"/>基于javaee的学科竞赛管理系统
             			<li><b>获奖等级:</b>&nbsp;<s:property value="#x.awardGrade"/>
              			<li><b>获奖名称:</b>&nbsp;<s:property value="#x.awardName"/>
                  ...
                  <!-- content-main start -->
                     <div class="posts-block col-lg-12 col-md-12 col-sm-12 col-xs-12 contentintro"><b>
                                                         作品简介：</b>&nbsp;<s:property value="#x.awardIntr"/>
                     </div>
               </div>
            </div>
            <!-- Main Content end-->
