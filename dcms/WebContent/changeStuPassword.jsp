                      ...
                      <div class="pull-right ">
                       ...
                       <div id="search-form" class="pull-left">
                        ...
                        <div  class="pull-right login" >
                              <a class=" pull-right" style="display:none" href="manage_login.jsp">Login Now</a>
                           </div>
                     ...
                     <div class="sidebar col-lg-3 col-md-3 col-sm-4 col-xs-12">
                      <div class="widget category">
                           ...
                           <ul class="category-list slide">
                              ...
                              <li><a href="#">系统更新</a></li>
                              <li><a href="#">关&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;于</a></li>
                			  <li><b id="StuInfocheck" style="cursor:pointer">修改密码</b></li>           
                              <li><a href="#">切换账号</a></li>
                    ...
                    <div class="col-lg-10 col-lg-offset-1 ">
                        ...
                        <div class="row">
                           <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
                                    ...
                                    当前密码<br><input type="text" id="stuOldPassword" name="stuOldPassword" calss="form-control" placeholder="Text input" style="width:220px"><br><br>
                            
         	新密码:<br><input type="text" id="stuNewPassword" name="stuNewPassword" calss="form-control" placeholder="Text input" style="width:220px"><br><br>
         	
         	确认密码 :<br><input type="text" id="stuConfirmPassword" name="stuConfirmPassword" calss="form-control" placeholder="Text input" style="width:220px"><br><br>       
                           </div>
                        </div>
                         <div class="blog-divider col-md-12">
                         </div>
                    </div>
                </div>
            </div>
                       <div class="pagination-centered bottom30px">
                        <input type="submit" class="btn btn-color btn-pad" value="保存" onclick="return stuModiPass()">
                        </div>                          
                     </div>
                      </form>
                      <!-- form end -->
