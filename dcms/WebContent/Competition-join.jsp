							...
							<div class="pannel pannel-heading ">
								<div class="row">
									<div class="col-xs-12 text-center bk-vcenter">
										<h3 class="border-bottom-primary text-primary  bk-padding-top-10 bk-padding-bottom-15">参赛学生查询</h3>
									</div>
								</div>
							</div>
							<div class="panel-body bk-padding-20">
								<form action="joinSearchComInfo.action" class="form-horizontal" role="form"  method="post" >
									<div class="row">
										<div class="col-md-10">
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon">竞赛名称</span>
													<input type="text" name="comName" class="form-control " placeholder="title" value="">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"  name="startTime" class="form-control" value="">
                                                    <span class="input-group-addon">to</span>
                                                    <input type="date"  name="stopTime" class="form-control" value="">
										...
										<table class="table table-striped  bootstrap-datatable datatable">
											...
											<tbody>		
												...
												<tr>
													...
													<td><a href="joincheck.action?ComId=<s:property value="comId"/>"  class="btn-check"><i class="fa fa-search-plus "></i>&nbsp;&nbsp;&nbsp;详情</a></td>
												</tr>
												</s:iterator>
											</tbody>
										</table>
