                            ...
                            <div class="row bk-bg-very-light-gray">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <div class="panel-body">
                                        <form action="searchComInfo" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">竞赛名称</span>
                                                            <input type="text" name="competition.comName" class="form-control " placeholder="竞赛名称" value="">
                                                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <button name="query" type="submit" onclick="add()" class="btn">查询</button>
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="col-md-12">
<!--
                                                   <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="col-md-2 control-lable text-left" for="text-input">竞赛级别：</label>
                                                                <div class="col-md-9">
                                                                    <div class="radio-custom  radio-inline">
