								...
								<ul class="nav nav-sidebar">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li><a href="discipline.jsp"><span class="text"> 竞赛推荐</span></a></li>
										</ul>
									</li>
									<li class="nav-parent">
										<a>
						...
						<div class="pannel pannel-heading ">
							<div class="row">
								<div class="col-xs-12 text-center bk-vcenter">
									<h2 class="bk-bg-primary  bk-padding-top-10 bk-padding-bottom-10 bk-padding-20">竞赛推荐</h2>
								</div>
							</div>
						</div>
					</div>
										...
										<table class="table table-striped  bootstrap-datatable datatable">
											...
											<tbody>
												...
												<s:iterator value="list" id="x">
													<tr>
														<td><s:property value="#x.recommendedName"/></td>
														<td><s:property value="#x.studentEmail"/></td>
														<td><a class=" bk-radius-18 btn btn-success" href="email.action?email=<s:property value="#x.studentEmail"/>&src=<s:property value="#x.studentDiscipline"/>"/><i class="fa fa-search-plus "></i>&nbsp;&nbsp;&nbsp;推荐</a></td>
													</tr>
												</s:iterator>
											</tbody>
										</table>
...
<body>
	<s:iterator value="list" id="x">
		...
		<s:property value="#x.studentDiscipline"/>
		<s:property value="#x.studentEmail"/>
		<a href="email.action?email=<s:property value="#x.studentEmail"/>&src=<s:property value="#x.studentDiscipline"/>"/>推荐</a>
	</s:iterator>
