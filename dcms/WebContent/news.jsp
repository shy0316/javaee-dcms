                     ...
                     <div class="posts-block col-lg-12 col-md-12 col-sm-11 col-xs-12 ">
                        ...
                        <div class="widget tabs">
                           <h3 class="title">新闻查询</h3>
                             <form class="query_news" action="searchNews.action" method="post">
                           <ul class="posts">
                             
			
			<li ><div class="query_l">新闻标题：</div></li>
			<li><input type="text" value="" id="manage-name-inp"  name="news.newsTitle" class="form-control"></li>
			<li><div class="query_l">新闻发布者：</div></li>
			 <li><input type="text" value="" id="manage-issuer-inp" name="news.newsIssuer"  class="form-control">
			</li>
			<li><div class="query_l">新闻发布时间：</div></li>
			<li><input type="date" value="" name="news.newsIssuedate" class="form-control">
			<br></li>
			<li>
			<div class="sidebar col-lg-1 col-md-1 col-sm-1 col-xs-1 col-md-offset-3">
			<button type="submit" class="subscribe-btn btn">查询</button></div></li>
