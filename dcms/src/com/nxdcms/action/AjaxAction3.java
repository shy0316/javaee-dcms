...
public class AjaxAction3 extends ActionSupport {
	private AjaxAction3 ajaxAction;
	private FenyeTest2 ft2 = new FenyeTest2();
	private List<Subcompetition> result=null;
	private static PageBean p = new PageBean(0, 5,0);
	public static PageBean getP() {
		return p;
	}
	public static void setP(PageBean p) {
		AjaxAction3.p = p;
	}
...
//			System.out.println(p.getPage());
	...
	public List<Subcompetition> getResult() {
		return result;
	}

	public void setResult(List<Subcompetition> result) {
		this.result = result;
	}
